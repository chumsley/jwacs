...
multiLineCommentChars:
	...
	| ASTERIK postAsterikCommentChars
	;
...
multiLineNotAsterikChar:
	sourceCharacter /* but not ASTERIK */
	;

multiLineNotForwardSlashOrAsterikChar:
	sourceCharacter /* but not FORWARD-SLASH or ASTERIK */
	;
...
punctuator:
	...
	| DOT | SEMI | APOSTROPHE | LT | GT | LE
	| GE | EQ2 | NE | EQ3 | NOTEQ2
...
singleEscapeCharacter:
	APOSTROPHE | QUOTE | BACKSLASH | LOWER_B | LOWER_F | LOWER_N | LOWER_R | LOWER_T | LOWER_V
	;
...
equalityExpression:
	 ...
	 * SPEC:
	 * relationalExpression
	 * | equalityExpression (EQ2|NEQ|EQ3|NEQ2) relationalExpression
	 */
	relationalExpression (equalityExpressionTail)*
	;

equalityExpressionTail:
	(EQ2|NEQ|EQ3|NEQ2) relationalExpression
	;
...
equalityExpressionNoln:
	 ...
	 * SPEC:
	 * relationalExpressionNoln
	 * | equalityExpressionNoln (EQ2|NEQ|EQ3|NEQ2) relationalExpressionNoln
	 */
	relationalExpressionNoln (equalityExpressionNolnTail)*
	;

equalityExpressionNolnTail:
	(EQ2|NEQ|EQ3|NEQ2) relationalExpressionNoln
	;
...
assignmentOperator:
	...
	EQ | STAR_EQ | DIVIDE_EQ | MOD_EQ | PLUS_EQ | MINUS_EQ | LSHIFT_EQ | RSHIFT_EQ
	| RSHIFT3_EQ | AMPER_EQ | CAROT_EQ | PIPE_EQ
	;
...
uriMark:
	MINUS | UNDERSCORE | DOT | EXCLAMATION | TILDE | ASTERIK | SQUOTE | LPAREN | RPAREN
	;
...
atom:
	...
	| characterClass
	| LPAREN ((COLON|EQ|EXCALAMATION)? disjunction) RPAREN
	;
...
/* Done with grammar, now on to lexical tokens etc. */
